...
@SequenceGenerator(
        name = "THIRTYS_SEQ_GN",
        sequenceName = "THIRTYS_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class ThirtyS {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "THIRTYS_SEQ_GN")
    @Column(name = "thirtys_id")
    private Long id;
    ...
    public ThirtyS(Integer confCase, Double confCaseRate, String createDate, Double criticalRate, Integer deathCnt,
