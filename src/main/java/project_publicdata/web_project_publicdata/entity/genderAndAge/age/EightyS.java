...
@SequenceGenerator(
        name = "EIGHTYS_SEQ_GN",
        sequenceName = "EIGHTYS_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class EightyS {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "EIGHTYS_SEQ_GN")
    @Column(name = "eightys_id")
    private Long id;
    ...
    public EightyS(Integer confCase, Double confCaseRate, String createDate, Double criticalRate, Integer deathCnt,
