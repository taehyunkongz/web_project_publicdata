...
@SequenceGenerator(
        name = "VACCINE_INCHEON_SEQ_GN",
        sequenceName = "VACCINE_INCHEON_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineIncheon {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_INCHEON_SEQ_GN"
    )
    @Column(name = "vaccine_incheon_id")
    private Long id;
    ...
    public VaccineIncheon(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
