...
@SequenceGenerator(
        name = "VACCINE_CHUNGBUK_SEQ_GN",
        sequenceName = "VACCINE_CHUNGBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineChungbuk {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_CHUNGBUK_SEQ_GN"
    )
    @Column(name = "vaccine_chungbuk_id")
    private Long id;
    ...
    public VaccineChungbuk(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
