...
@SequenceGenerator(
        name = "VACCINE_DAEGU_SEQ_GN",
        sequenceName = "VACCINE_DAEGU_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineDaegu {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_DAEGU_SEQ_GN"
    )
    @Column(name = "vaccine_daegu_id")
    private Long id;
    ...
    public VaccineDaegu(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
