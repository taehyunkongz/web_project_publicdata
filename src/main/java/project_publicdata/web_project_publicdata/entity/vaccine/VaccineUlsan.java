...
@SequenceGenerator(
        name = "VACCINE_ULSAN_SEQ_GN",
        sequenceName = "VACCINE_ULSAN_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineUlsan {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_ULSAN_SEQ_GN"
    )
    @Column(name = "vaccine_ulsan_id")
    private Long id;
    ...
    public VaccineUlsan(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
