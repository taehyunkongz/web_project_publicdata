...
@SequenceGenerator(
        name = "VACCINE_JEONNAM_SEQ_GN",
        sequenceName = "VACCINE_JEONNAM_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineJeonnam {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_JEONNAM_SEQ_GN"
    )
    @Column(name = "vaccine_jeonnam_id")
    private Long id;
    ...
    public VaccineJeonnam(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
