...
@SequenceGenerator(
        name = "VACCINE_DAEJEON_SEQ_GN",
        sequenceName = "VACCINE_DAEJEON_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineDaejeon {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_DAEJEON_SEQ_GN"
    )
    @Column(name = "vaccine_daejeon_id")
    private Long id;
    ...
    public VaccineDaejeon(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
