...
@SequenceGenerator(
        name = "VACCINE_SEOUL_SEQ_GN",
        sequenceName = "VACCINE_SEOUL_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineSeoul {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_SEOUL_SEQ_GN"
    )
    @Column(name = "vaccine_seoul_id")
    private Long id;
    ...
    public VaccineSeoul(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
