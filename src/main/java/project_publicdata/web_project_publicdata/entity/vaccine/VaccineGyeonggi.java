...
@SequenceGenerator(
        name = "VACCINE_GYEONGGI_SEQ_GN",
        sequenceName = "VACCINE_GYEONGGI_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineGyeonggi {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_GYEONGGI_SEQ_GN"
    )
    @Column(name = "vaccine_gyeonggi_id")
    private Long id;
    ...
    public VaccineGyeonggi(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
