...
@SequenceGenerator(
        name = "VACCINE_SEJONG_SEQ_GN",
        sequenceName = "VACCINE_SEJONG_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineSejong {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_SEJONG_SEQ_GN"
    )
    @Column(name = "vaccine_sejong_id")
    private Long id;
    ...
    public VaccineSejong(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
