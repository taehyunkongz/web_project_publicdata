...
@SequenceGenerator(
        name = "VACCINE_BUSAN_SEQ_GN",
        sequenceName = "VACCINE_BUSAN_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineBusan {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_BUSAN_SEQ_GN"
    )
    @Column(name = "vaccine_busan_id")
    private Long id;
    ...
    public VaccineBusan(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
