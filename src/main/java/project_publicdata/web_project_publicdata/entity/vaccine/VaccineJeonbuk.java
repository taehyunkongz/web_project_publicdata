...
@SequenceGenerator(
        name = "VACCINE_JEONBUK_SEQ_GN",
        sequenceName = "VACCINE_JEONBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineJeonbuk {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_JEONBUK_SEQ_GN"
    )
    @Column(name = "vaccine_jeonbuk_id")
    private Long id;
    ...
    public VaccineJeonbuk(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
