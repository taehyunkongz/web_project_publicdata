...
@SequenceGenerator(
        name = "VACCINE_CHUNGNAM_SEQ_GN",
        sequenceName = "VACCINE_CHUNGNAM_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineChungnam {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_CHUNGNAM_SEQ_GN"
    )
    @Column(name = "vaccine_chungnam_id")
    private Long id;
    ...
    public VaccineChungnam(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
