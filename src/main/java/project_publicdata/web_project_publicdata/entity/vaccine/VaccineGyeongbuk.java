...
@SequenceGenerator(
        name = "VACCINE_GYEONGBUK_SEQ_GN",
        sequenceName = "VACCINE_GYEONGBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class VaccineGyeongbuk {
    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VACCINE_GYEONGBUK_SEQ_GN"
    )
    @Column(name = "vaccine_gyeongbuk_id")
    private Long id;
    ...
    public VaccineGyeongbuk(Integer accFirstCnt, Integer accSecondCnt, Integer accThirdCnt, Integer firstCnt, Integer secondCnt,
