...
@SequenceGenerator(
        name = "CHUNGBUK_SEQ_GN",
        sequenceName = "CHUNGBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class Chungbuk extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "CHUNGBUK_SEQ_GN"
    )
    @Column(name = "chungbuk_id")
    private Long id;
    ...
    public Chungbuk(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
