...
@SequenceGenerator(
        name = "GYEONGBUK_SEQ_GN",
        sequenceName = "GYEONGBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Gyeongbuk extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "GYEONGBUK_SEQ_GN"
    )
    @Column(name = "gyeongbuk_id")
    private Long id;
    ...
    public Gyeongbuk(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
