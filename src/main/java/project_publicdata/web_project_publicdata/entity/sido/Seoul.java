...
@SequenceGenerator(
        name = "SEOUL_SEQ_GN",
        sequenceName = "SEOUL_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Seoul extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "SEOUL_SEQ_GN"
    )
    ...
    public Seoul(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
