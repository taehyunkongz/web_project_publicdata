...
@SequenceGenerator(
        name = "SEJONG_SEQ_GN",
        sequenceName = "SEJONG_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Sejong extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "SEJONG_SEQ_GN"
    )
    @Column(name = "sejong_id")
    private Long id;
    ...
    public Sejong(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
