...
@SequenceGenerator(
        name = "TOTAL_SEQ_GN",
        sequenceName = "TOTAL_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Total extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "TOTAL_SEQ_GN"
    )
    ...
    public Total(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
