...
@SequenceGenerator(
        name = "JEONBUK_SEQ_GN",
        sequenceName = "JEONBUK_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Jeonbuk extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "JEONBUK_SEQ_GN"
    )
    @Column(name = "jeonbuk_id")
    private Long id;
    ...
    public Jeonbuk(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
