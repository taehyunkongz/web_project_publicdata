...
@SequenceGenerator(
        name = "ULSAN_SEQ_GN",
        sequenceName = "ULSAN_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Ulsan extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "ULSAN_SEQ_GN"
    )
    ...
    public Ulsan(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
