...
@SequenceGenerator(
        name = "DAEJEON_SEQ_GN",
        sequenceName = "DAEJEON_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class Daejeon extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "DAEJEON_SEQ_GN"
    )
    @Column(name = "daejeon_id")
    private Long id;
    ...
    public Daejeon(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
