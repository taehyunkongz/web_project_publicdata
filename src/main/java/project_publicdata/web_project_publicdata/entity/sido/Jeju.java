...
@SequenceGenerator(
        name = "JEJU_SEQ_GN",
        sequenceName = "JEJU_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Jeju extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "JEJU_SEQ_GN"
    )
    @Column(name = "jeju_id")
    private Long id;
    ...
    public Jeju(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
