...
@SequenceGenerator(
        name = "GYEONGGI_SEQ_GN",
        sequenceName = "GYEONGGI_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Gyeonggi extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "GYEONGGI_SEQ_GN"
    )
    @Column(name = "gyeonggi_id")
    private Long id;
    ...
    public Gyeonggi(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
