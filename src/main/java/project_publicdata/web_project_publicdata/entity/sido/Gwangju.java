...
@SequenceGenerator(
        name = "GWANGJU_SEQ_GN",
        sequenceName = "GWANGJU_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Gwangju extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "GWANGJU_SEQ_GN"
    )
    @Column(name = "gwangju_id")
    private Long id;
    ...
    public Gwangju(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
