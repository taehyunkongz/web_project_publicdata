...
@SequenceGenerator(
        name = "GYEONGNAM_SEQ_GN",
        sequenceName = "GYEONGNAM_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Gyeongnam extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "GYEONGNAM_SEQ_GN"
    )
    @Column(name = "gyeongnam_id")
    private Long id;
    ...
    public Gyeongnam(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
