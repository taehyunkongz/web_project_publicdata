...
@SequenceGenerator(
        name = "JEONNAM_SEQ_GN",
        sequenceName = "JEONNAM_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Jeonnam extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "JEONNAM_SEQ_GN"
    )
    @Column(name = "jeonnam_id")
    private Long id;
    ...
    public Jeonnam(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
