...
@SequenceGenerator(
        name = "LAZARETTO_SEQ_GN",
        sequenceName = "LAZARETTO_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Lazaretto extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "LAZARETTO_SEQ_GN"
    )
    @Column(name = "lazaretto_id")
    private Long id;
    ...
    public Lazaretto(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
