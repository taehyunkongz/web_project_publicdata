...
@SequenceGenerator(
        name = "CHUNGNAM_SEQ_GN",
        sequenceName = "CHUNGNAM_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Chungnam extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "CHUNGNAM_SEQ_GN")
    @Column(name = "chungnam_id")
    private Long id;
    ...
    public Chungnam(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
