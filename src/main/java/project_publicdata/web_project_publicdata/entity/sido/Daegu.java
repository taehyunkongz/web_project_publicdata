...
@SequenceGenerator(
        name = "DAEGU_SEQ_GN",
        sequenceName = "DAEGU_SEQ",
        initialValue = 1,
        allocationSize = 1
)
public class Daegu extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "DAEGU_SEQ_GN"
    )
    @Column(name = "daegu_id")
    private Long id;
    ...
    public Daegu(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
