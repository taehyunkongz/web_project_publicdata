...
@SequenceGenerator(
        name = "INCHEON_SEQ_GN",
        sequenceName = "INCHEON_SEQ",
        initialValue = 1,
        allocationSize = 1
)

public class Incheon extends BaseTimeEntity {

    @Id
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "INCHEON_SEQ_GN"
    )
    @Column(name = "incheon_id")
    private Long id;
    ...
    public Incheon(Integer defCnt, Integer isolClearCnt, Integer localOccCnt, Integer incDec, String gubun, String gubunEn,
